...
![](./images/原型闭包/172012532064920.png)
...
![](./images/原型闭包/172138591437263.png)
...
![](./images/原型闭包/181508179098239.png)

![](./images/原型闭包/181508340651970.png)
...
![](./images/原型闭包/181509180812624.png)
...
![](./images/原型闭包/181510403153733.png)
...
![](./images/原型闭包/181511124714709.png)
...
![](./images/原型闭包/181512068463597.png)
...
![](./images/原型闭包/181512489403338.png)
...
![](./images/原型闭包/181636252689920.png)
...
![](./images/原型闭包/181637013624694.png)
...
![](./images/原型闭包/182012548152475.png)
...
![](./images/原型闭包/182013450814552.png)
...
![](./images/原型闭包/182014022217881.png)
...
![](./images/原型闭包/182014277067963.png)
...
![](./images/原型闭包/182015334711671.png)
...
![](./images/原型闭包/221743466231490.png)
...
![](./images/原型闭包/221744084828533.png)

这是第一种情况。

下面还有。先来个简单的。

![](./images/原型闭包/221744319354566.png)
...
![](./images/原型闭包/221745066078791.png)
...
![](./images/原型闭包/221746370927602.png)

其次，eval代码接收的也是一段文本形式的代码。

![](./images/原型闭包/221747371078703.png)

最后，函数体是代码段是因为函数在创建时，本质上是 new Function(…) 得来的，其中需要传入一个文本形式的参数作为函数体。

![](./images/原型闭包/221746583578531.png)
...
![](./images/原型闭包/230840377174282.png)
...
![](./images/原型闭包/230841277489133.png)
...
![](./images/原型闭包/231454121399180.png)

**情况4：全局 & 调用普通函数**

在全局环境下，this永远是window，这个应该没有非议。

![](./images/原型闭包/231454368571699.png)

普通函数在调用时，其中的this也都是window。

![](./images/原型闭包/231454563265514.png)

以上代码很好理解。

不过下面的情况你需要注意一下：

![](./images/原型闭包/231455260602664.png)
...
![](./images/原型闭包/231455536397656.png)
...
![](./images/原型闭包/241706483263428.png)

再比如for语句：

![](./images/原型闭包/241707060293268.png)

所以，我们在编写代码的时候，不要在“块”里面声明变量，要在代码的一开始就声明好了。以避免发生歧义。如：

![](./images/原型闭包/241707273423913.png)
...
![](./images/原型闭包/241708128263977.png)

下面继续说作用域。作用域是一个很抽象的概念，类似于一个“地盘”

![](./images/原型闭包/241708372951952.png)
...
![](./images/原型闭包/241709349512366.png)
...
![](./images/原型闭包/250813253577626.png)
...
![](./images/原型闭包/251448515607115.png)
...
![](./images/原型闭包/260749156077205.png)

第一步，代码执行前生成全局上下文环境，并在执行时对其中的变量进行赋值。此时全局上下文环境是活动状态。

![](./images/原型闭包/260749349988764.png)

第二步，执行第17行代码时，调用fn()，产生fn()执行上下文环境，压栈，并设置为活动状态。

![](./images/原型闭包/260750319351092.png)
...
![](./images/原型闭包/260957500455644.png)

第四步，执行到第20行，执行f1(15)，即执行bar(15)，创建bar(15)上下文环境，并将其设置为活动状态。

![](./images/原型闭包/260958057327369.png)
